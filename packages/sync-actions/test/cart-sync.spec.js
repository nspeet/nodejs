...
describe('Exports', () => {
  ...
  test('correctly define base actions list', () => {
    expect(baseActionsList).toEqual([
      ...
      //cart sync actions to test
      { action: 'changeTaxMode', key: 'taxMode' },
      { action: 'changeLineItems', key: 'lineItems' },
      { action: 'changeCustomLineItems', key: 'customLineItems' }
    ])
  })
})
